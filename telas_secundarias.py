...
def tela_vizualizacao_remover_alunos():
    ...
    def busca_automatica():
        ...
        janela_2_alunos.after(500, busca_automatica)
...
def tela_visualizacao_remover_emprestimo():
    ...
    def busca_automatica():
        ...
        janela_3_emprestimo.after(500, busca_automatica)
    ...
    id_emprestimo.grid(row=7, column=0, padx=20, pady=40)
    ...
    nome_remove_emprestimo.grid(row=7, column=1, padx=20, pady=40)

    botao_remover_aluno = customtkinter.CTkButton(frame_remocao, text='Remover', font=('Ariel', 14, 'bold'),
    fg_color='Red', command=lambda : remover_emprestimo(id_emprestimo, nome_remove_emprestimo, master=frame_remocao))
    botao_remover_aluno.grid(row=8, column=0, columnspan=2, pady=20)

    # caixa_remover_emprestimo = customtkinter.CTkTextbox(frame_remocao, width=180, height=10)
    # caixa_remover_emprestimo.grid(row=3, column=0, columnspan=2, pady=10)
